...
很久之后补充：这里面有深刻的容斥，与线性方程组（高斯消元）、矩阵求逆、DAG dp什么的都有关. 总的来说是任意一个偏序集添加最小元后系数为 $-\mu$ 的容斥. 
...
> 6月24日 upd: 单独开了一个md. 写完整了，非常舒服，就是周一presentation不知道咋办了. 
...
我宣布 at_abc308_h 是好题！有两种做法，一种是**最短路树**性质的应用，另一种是常见的删物品 dp **分治**套路（多 log）. 应当找时间补题并写题解. 

> 但是期末考试要挂了……所以以后再说吧. 

NOIp后要系统复习点分治. 新例题：Tree MST. 
...
带病考试又怎样，高一都这么干四次了，谁怕谁啊. 

---

7月12日

考完啦. 要逐步恢复卷oi了. 又是一个不放假的暑假（. 
...
绿题，但有个简单的转化：虽然问的是“$W\ge0$ 的前提下最大化 $n$”，应该求“每个 $n$ 值下最大的 $W$”. 可以联想到“如果一个东西值域太大，就把它放在状态的值里，不要放在下标上”. 
